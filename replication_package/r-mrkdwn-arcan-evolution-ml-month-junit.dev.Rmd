...
# library(data.table)
# pkg.merged<-fread("cache/dev.junit/package_merged.csv")
...
set.seed(825)
confusionMatricesNB <- runCV(pkg.dataset.nzv, models, targets, "dev.junit-month-")
write.csv(confusionMatricesNB, "dev.junit-month-cm-ALL-nb.csv")
#```

#```{r train C5.0 and all targets}
models <- c("C5.0") # "C5.0" "logreg" has some issues, should be tested outside
set.seed(825)
confusionMatricesC50 <- runCV(pkg.dataset.nzv, models, targets, "dev.junit-month-")
write.csv(confusionMatricesC50, "dev.junit-month-cm-ALL-c50.csv")
#```
...
set.seed(825)
confusionMatricesRF <- runCV(pkg.dataset.nzv, models, targets, "dev.junit-month-")
write.csv(confusionMatricesRF, "dev.junit-month-cm-ALL-rf.csv")
#```

#```{r write all confusion matrices}
write.csv(rbind(confusionMatricesNB, confusionMatricesC50, confusionMatricesRF), "dev.junit-month-cm-ALL-ALL.csv")
```
...
models <- c("nb") # "C5.0" "logreg" has some issues, should be tested outside
set.seed(825)
confusionMatricesNB <- runCV.smote(pkg.dataset.nzv, models, targets, "smote.dev.junit-month-")
write.csv(confusionMatricesNB, "smote.dev.junit-month-cm-ALL-nb.csv")
#```

#```{r train C5.0 and all targets}
models <- c("C5.0") # "C5.0" "logreg" has some issues, should be tested outside
set.seed(825)
confusionMatricesC50 <- runCV.smote(pkg.dataset.nzv, models, targets, "smote.dev.junit-month-")
write.csv(confusionMatricesC50, "smote.dev.junit-month-cm-ALL-c50.csv")
#```
...
models <- c("rf") # "C5.0" "logreg" has some issues, should be tested outside
set.seed(825)
confusionMatricesRF <- runCV.smote(pkg.dataset.nzv, models, targets, "smote.dev.junit-month-")
write.csv(confusionMatricesRF, "smote.dev.junit-month-cm-ALL-rf.csv")
#```

#```{r write all confusion matrices}
write.csv(rbind(confusionMatricesNB, confusionMatricesC50, confusionMatricesRF), "smote.dev.junit-month-cm-ALL-ALL.csv")
```
...
confusionMatricesSVMRadial <- runCV.svm(pkg.dataset.nzv, grid, models, targets, "dev.junit-month-")
write.csv(confusionMatricesSVMRadial, "dev.junit-month-cm-ALL-svm-radial.csv")
```
...
confusionMatricesSVMlinear <- runCV.svm(pkg.dataset.nzv, grid, models, targets, "dev.junit-month-")
write.csv(confusionMatricesSVMlinear, "dev.junit-month-cm-ALL-svm-linear.csv")
```

[1] "Model: nb"
 [1] "star"           "numjavafile-1"  "nummail-1"      "numClasses-1"   "IXPD-1"         "numPackages-1"  "tiny-1"         "chain-1"        "CD-1"          
[10] "numjavafile-2"  "nummail-2"      "numClasses-2"   "IXPD-2"         "tiny-2"         "chain-2"        "CD-2"           "numjavafile-3"  "nummail-3"     
[19] "numClasses-3"   "IXPD-3"         "tiny-3"         "chain-3"        "CD-3"           "numjavafile-4"  "nummail-4"      "numClasses-4"   "IXPD-4"        
[28] "numPackages-4"  "tiny-4"         "chain-4"        "CD-4"           "numjavafile-5"  "nummail-5"      "numClasses-5"   "IXPD-5"         "numPackages-5" 
[37] "tiny-5"         "chain-5"        "CD-5"           "numjavafile-6"  "nummail-6"      "numClasses-6"   "IXPD-6"         "numPackages-6"  "tiny-6"        
[46] "chain-6"        "CD-6"           "numjavafile-7"  "nummail-7"      "numClasses-7"   "IXPD-7"         "tiny-7"         "chain-7"        "CD-7"          
[55] "numjavafile-8"  "nummail-8"      "numClasses-8"   "IXPD-8"         "tiny-8"         "chain-8"        "CD-8"           "numjavafile-9"  "nummail-9"     
[64] "numClasses-9"   "IXPD-9"         "tiny-9"         "chain-9"        "CD-9"           "numjavafile-10" "nummail-10"     "numClasses-10"  "IXPD-10"       
[73] "tiny-10"        "chain-10"       "CD-10"          "numjavafile-11" "nummail-11"     "numClasses-11"  "IXPD-11"        "tiny-11"        "chain-11"      
[82] "CD-11"          "numjavafile-12" "nummail-12"     "numClasses-12"  "IXPD-12"        "tiny-12"        "chain-12"       "CD-12"         
Aggregating results
Selecting tuning parameters
Fitting fL = 0, usekernel = TRUE, adjust = 1 on full training set
[1] "Model: nb"
 [1] "tiny"           "numjavafile-1"  "nummail-1"      "numClasses-1"   "IXPD-1"         "numPackages-1"  "tiny-1"         "chain-1"        "CD-1"          
[10] "numjavafile-2"  "nummail-2"      "numClasses-2"   "IXPD-2"         "tiny-2"         "chain-2"        "CD-2"           "numjavafile-3"  "nummail-3"     
[19] "numClasses-3"   "IXPD-3"         "tiny-3"         "chain-3"        "CD-3"           "numjavafile-4"  "nummail-4"      "numClasses-4"   "IXPD-4"        
[28] "numPackages-4"  "tiny-4"         "chain-4"        "CD-4"           "numjavafile-5"  "nummail-5"      "numClasses-5"   "IXPD-5"         "numPackages-5" 
[37] "tiny-5"         "chain-5"        "CD-5"           "numjavafile-6"  "nummail-6"      "numClasses-6"   "IXPD-6"         "numPackages-6"  "tiny-6"        
...
[1] "Model: nb"
 [1] "chain"          "numjavafile-1"  "nummail-1"      "numClasses-1"   "IXPD-1"         "numPackages-1"  "tiny-1"         "chain-1"        "CD-1"          
[10] "numjavafile-2"  "nummail-2"      "numClasses-2"   "IXPD-2"         "tiny-2"         "chain-2"        "CD-2"           "numjavafile-3"  "nummail-3"     
[19] "numClasses-3"   "IXPD-3"         "tiny-3"         "chain-3"        "CD-3"           "numjavafile-4"  "nummail-4"      "numClasses-4"   "IXPD-4"        
[28] "numPackages-4"  "tiny-4"         "chain-4"        "CD-4"           "numjavafile-5"  "nummail-5"      "numClasses-5"   "IXPD-5"         "numPackages-5" 
[37] "tiny-5"         "chain-5"        "CD-5"           "numjavafile-6"  "nummail-6"      "numClasses-6"   "IXPD-6"         "numPackages-6"  "tiny-6"        
...
Fitting fL = 0, usekernel = TRUE, adjust = 1 on full training set
[1] "Model: nb"
 [1] "CD"             "numjavafile-1"  "nummail-1"      "numClasses-1"   "IXPD-1"         "numPackages-1"  "tiny-1"         "chain-1"        "CD-1"          
[10] "numjavafile-2"  "nummail-2"      "numClasses-2"   "IXPD-2"         "tiny-2"         "chain-2"        "CD-2"           "numjavafile-3"  "nummail-3"     
[19] "numClasses-3"   "IXPD-3"         "tiny-3"         "chain-3"        "CD-3"           "numjavafile-4"  "nummail-4"      "numClasses-4"   "IXPD-4"        
[28] "numPackages-4"  "tiny-4"         "chain-4"        "CD-4"           "numjavafile-5"  "nummail-5"      "numClasses-5"   "IXPD-5"         "numPackages-5" 
[37] "tiny-5"         "chain-5"        "CD-5"           "numjavafile-6"  "nummail-6"      "numClasses-6"   "IXPD-6"         "numPackages-6"  "tiny-6"        
...
Fitting fL = 0, usekernel = TRUE, adjust = 1 on full training set
[1] "Model: nb"
 [1] "UD"             "numjavafile-1"  "nummail-1"      "numClasses-1"   "IXPD-1"         "numPackages-1"  "tiny-1"         "chain-1"        "CD-1"          
[10] "numjavafile-2"  "nummail-2"      "numClasses-2"   "IXPD-2"         "tiny-2"         "chain-2"        "CD-2"           "numjavafile-3"  "nummail-3"     
[19] "numClasses-3"   "IXPD-3"         "tiny-3"         "chain-3"        "CD-3"           "numjavafile-4"  "nummail-4"      "numClasses-4"   "IXPD-4"        
[28] "numPackages-4"  "tiny-4"         "chain-4"        "CD-4"           "numjavafile-5"  "nummail-5"      "numClasses-5"   "IXPD-5"         "numPackages-5" 
[37] "tiny-5"         "chain-5"        "CD-5"           "numjavafile-6"  "nummail-6"      "numClasses-6"   "IXPD-6"         "numPackages-6"  "tiny-6"        
...
Fitting fL = 0, usekernel = FALSE, adjust = 1 on full training set
[1] "Model: nb"
 [1] "IXPD"           "numjavafile-1"  "nummail-1"      "numClasses-1"   "IXPD-1"         "numPackages-1"  "tiny-1"         "chain-1"        "CD-1"          
[10] "numjavafile-2"  "nummail-2"      "numClasses-2"   "IXPD-2"         "tiny-2"         "chain-2"        "CD-2"           "numjavafile-3"  "nummail-3"     
[19] "numClasses-3"   "IXPD-3"         "tiny-3"         "chain-3"        "CD-3"           "numjavafile-4"  "nummail-4"      "numClasses-4"   "IXPD-4"        
[28] "numPackages-4"  "tiny-4"         "chain-4"        "CD-4"           "numjavafile-5"  "nummail-5"      "numClasses-5"   "IXPD-5"         "numPackages-5" 
[37] "tiny-5"         "chain-5"        "CD-5"           "numjavafile-6"  "nummail-6"      "numClasses-6"   "IXPD-6"         "numPackages-6"  "tiny-6"        
...
# models <- c("C5.0") # "C5.0" "logreg" has some issues, should be tested outside
# set.seed(825)
# trainC50 <- run50CV(pkg.dataset.nzv.binary, models, targets, "dev.junit-")

# library(rJava)
modelLookup("JRip")
models <- c("JRip")
set.seed(825)
trainjrip <- run50CV(pkg.dataset.nzv.binary, models, targets, "dev.junit-")
# write.csv(pkg.dataset.nzv.binary, "dev.junit-cm-lagged-week.csv")
...
c50.6 <- trainjrip$`9`$finalModel #ixpd
    ...
    write(as.character(summary(c50.1)), "data/rule/dev.junit-jrip-month-c50.star.txt")
    write(as.matrix(scan(text = .jcall(c50.1$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule/dev.junit-jrip-month-c50.star.txt", append = TRUE)
    write(as.character(summary(c50.2)), "data/rule/dev.junit-jrip-month-c50.tiny.txt")
    write(as.matrix(scan(text = .jcall(c50.2$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule/dev.junit-jrip-month-c50.tiny.txt", append = TRUE)
    write(as.character(summary(c50.3)), "data/rule/dev.junit-jrip-month-c50.chain.txt")
    write(as.matrix(scan(text = .jcall(c50.3$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule/dev.junit-jrip-month-c50.chain.txt", append = TRUE)
    write(as.character(summary(c50.4)), "data/rule/dev.junit-jrip-month-c50.cd.txt")
    write(as.matrix(scan(text = .jcall(c50.4$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule/dev.junit-jrip-month-c50.cd.txt", append = TRUE)
    write(as.character(summary(c50.5)), "data/rule/dev.junit-jrip-month-c50.ud.txt")
    write(as.matrix(scan(text = .jcall(c50.5$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule/dev.junit-jrip-month-c50.ud.txt", append = TRUE)
    write(as.character(summary(c50.6)), "data/rule/dev.junit-jrip-month-c50.ixpd.txt")
    write(as.matrix(scan(text = .jcall(c50.6$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule/dev.junit-jrip-month-c50.ixpd.txt", append = TRUE)
...
models <- c("JRip")
set.seed(825)
trainjrip <- run50CV.smote(pkg.dataset.nzv.binary, models, targets, "dev.junit-")
# write.csv(pkg.dataset.nzv.binary, "dev.junit-cm-lagged-week.csv")
...
c50.6 <- trainjrip$`9`$finalModel #ixpd
    ...
    write(as.character(summary(c50.1)), "data/rule.smote/dev.junit-jrip-month-c50.star.txt")
    write(as.matrix(scan(text = .jcall(c50.1$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule.smote/dev.junit-jrip-month-c50.star.txt", append = TRUE)
    write(as.character(summary(c50.2)), "data/rule.smote/dev.junit-jrip-month-c50.tiny.txt")
    write(as.matrix(scan(text = .jcall(c50.2$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule.smote/dev.junit-jrip-month-c50.tiny.txt", append = TRUE)
    write(as.character(summary(c50.3)), "data/rule.smote/dev.junit-jrip-month-c50.chain.txt")
    write(as.matrix(scan(text = .jcall(c50.3$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule.smote/dev.junit-jrip-month-c50.chain.txt", append = TRUE)
    write(as.character(summary(c50.4)), "data/rule.smote/dev.junit-jrip-month-c50.cd.txt")
    write(as.matrix(scan(text = .jcall(c50.4$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule.smote/dev.junit-jrip-month-c50.cd.txt", append = TRUE)
    write(as.character(summary(c50.5)), "data/rule.smote/dev.junit-jrip-month-c50.ud.txt")
    write(as.matrix(scan(text = .jcall(c50.5$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule.smote/dev.junit-jrip-month-c50.ud.txt", append = TRUE)
    write(as.character(summary(c50.6)), "data/rule.smote/dev.junit-jrip-month-c50.ixpd.txt")
    write(as.matrix(scan(text = .jcall(c50.6$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule.smote/dev.junit-jrip-month-c50.ixpd.txt", append = TRUE)
