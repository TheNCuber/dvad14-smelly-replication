...
set.seed(825)
confusionMatricesNB <- runCV(pkg.dataset.nzv, models, targets, "dev.only.tomcat-month-")
write.csv(confusionMatricesNB, "dev.only.tomcat-month-cm-ALL-nb.csv")
#```

#```{r train C5.0 and all targets}
models <- c("C5.0") # "C5.0" "logreg" has some issues, should be tested outside
set.seed(825)
confusionMatricesC50 <- runCV(pkg.dataset.nzv, models, targets, "dev.only.tomcat-month-")
write.csv(confusionMatricesC50, "dev.only.tomcat-month-cm-ALL-c50.csv")
#```
...
set.seed(825)
confusionMatricesRF <- runCV(pkg.dataset.nzv, models, targets, "dev.only.tomcat-month-")
write.csv(confusionMatricesRF, "dev.only.tomcat-month-cm-ALL-rf.csv")
#```

#```{r write all confusion matrices}
write.csv(rbind(confusionMatricesNB, confusionMatricesC50, confusionMatricesRF), "dev.only.tomcat-month-cm-ALL-ALL.csv")
```
...
models <- c("nb") # "C5.0" "logreg" has some issues, should be tested outside
set.seed(825)
confusionMatricesNB <- runCV.smote(pkg.dataset.nzv, models, targets, "smote.dev.only.tomcat-month-")
write.csv(confusionMatricesNB, "smote.dev.only.tomcat-month-cm-ALL-nb.csv")
#```

#```{r train C5.0 and all targets}
models <- c("C5.0") # "C5.0" "logreg" has some issues, should be tested outside
set.seed(825)
confusionMatricesC50 <- runCV.smote(pkg.dataset.nzv, models, targets, "smote.dev.only.tomcat-month-")
write.csv(confusionMatricesC50, "smote.dev.only.tomcat-month-cm-ALL-c50.csv")
#```
...
models <- c("rf") # "C5.0" "logreg" has some issues, should be tested outside
set.seed(825)
confusionMatricesRF <- runCV.smote(pkg.dataset.nzv, models, targets, "smote.dev.only.tomcat-month-")
write.csv(confusionMatricesRF, "smote.dev.only.tomcat-month-cm-ALL-rf.csv")
#```

#```{r write all confusion matrices}
write.csv(rbind(confusionMatricesNB, confusionMatricesC50, confusionMatricesRF), "smote.dev.only.tomcat-month-cm-ALL-ALL.csv")
```
...
confusionMatricesSVMRadial <- runCV.svm(pkg.dataset.nzv, grid, models, targets, "dev.only.tomcat-month-")
write.csv(confusionMatricesSVMRadial, "dev.only.tomcat-month-cm-ALL-svm-radial.csv")
...
confusionMatricesSVMlinear <- runCV.svm(pkg.dataset.nzv, grid, models, targets, "dev.only.tomcat-month-")
write.csv(confusionMatricesSVMlinear, "dev.only.tomcat-month-cm-ALL-svm-linear.csv")
```
...
# models <- c("C5.0") # "C5.0" "logreg" has some issues, should be tested outside
# set.seed(825)
# trainC50 <- run50CV(pkg.dataset.nzv.binary, models, targets, "dev.only.tomcat-")

modelLookup("JRip")
models <- c("JRip")
set.seed(825)
trainjrip <- run50CV(pkg.dataset.nzv.binary, models, targets, "dev.only.tomcat-")
# write.csv(pkg.dataset.nzv.binary, "dev.only.tomcat-cm-lagged-week.csv")
...
library(rJava)
write(as.character(summary(c50.1)),"data/rule/dev.only.tomcat-jrip-month-c50.star.txt")
write(as.matrix(scan(text=.jcall(c50.1$classifier, "S", "toString") ,sep="\n", what="") )[
    -c(1:2, 6), ,drop=FALSE],"data/rule/dev.only.tomcat-jrip-month-c50.star.txt",append=TRUE)
write(as.character(summary(c50.2)),"data/rule/dev.only.tomcat-jrip-month-c50.clique.txt")
write(as.matrix(scan(text=.jcall(c50.2$classifier, "S", "toString") ,sep="\n", what="") )[
    -c(1:2, 6), ,drop=FALSE],"data/rule/dev.only.tomcat-jrip-month-c50.clique.txt",append=TRUE)
write(as.character(summary(c50.3)),"data/rule/dev.only.tomcat-jrip-month-c50.chain.txt")
write(as.matrix(scan(text=.jcall(c50.3$classifier, "S", "toString") ,sep="\n", what="") )[
    -c(1:2, 6), ,drop=FALSE],"data/rule/dev.only.tomcat-jrip-month-c50.chain.txt",append=TRUE)
write(as.character(summary(c50.4)),"data/rule/dev.only.tomcat-jrip-month-c50.CD.txt")
write(as.matrix(scan(text=.jcall(c50.4$classifier, "S", "toString") ,sep="\n", what="") )[
    -c(1:2, 6), ,drop=FALSE],"data/rule/dev.only.tomcat-jrip-month-c50.CD.txt",append=TRUE)
write(as.character(summary(c50.5)),"data/rule/dev.only.tomcat-jrip-month-c50.IXPD.txt")
write(as.matrix(scan(text=.jcall(c50.5$classifier, "S", "toString") ,sep="\n", what="") )[
    -c(1:2, 6), ,drop=FALSE],"data/rule/dev.only.tomcat-jrip-month-c50.IXPD.txt",append=TRUE)
...
# writeChar(as.character(summary(c50.1)),"data/rule/dev.only.tomcat-week-c50.star.txt")
# writeChar(as.character(summary(c50.2)),"data/rule/dev.only.tomcat-week-c50.clique.txt")
# writeChar(as.character(summary(c50.3)),"data/rule/dev.only.tomcat-week-c50.chain.txt")
# writeChar(as.character(summary(c50.4)),"data/rule/dev.only.tomcat-week-c50.CD.txt")
# writeChar(as.character(summary(c50.5)),"data/rule/dev.only.tomcat-week-c50.IXPD.txt")
```


```{r read all confusion matrices}
# library(plyr)
files <- list.files(path = "data/ml-results/tomcat/month", pattern = ".csv")
# temp <- lapply(files, read.csv,header=TRUE,sep=",")
readFromCsv <- function(filename, header=TRUE, sep=","){
    ret <- read.csv(paste0("data/ml-results/tomcat/month/",filename),header,sep)
...
c50.5 <- trainjrip$`9`$finalModel #ixpd
library(rJava)
write(as.character(summary(c50.1)),"data/rule.smote/dev.only.tomcat-jrip-month-c50.star.txt")
write(as.matrix(scan(text=.jcall(c50.1$classifier, "S", "toString") ,sep="\n", what="") )[
    -c(1:2, 6), ,drop=FALSE],"data/rule.smote/dev.only.tomcat-jrip-month-c50.star.txt",append=TRUE)
write(as.character(summary(c50.2)),"data/rule.smote/dev.only.tomcat-jrip-month-c50.clique.txt")
write(as.matrix(scan(text=.jcall(c50.2$classifier, "S", "toString") ,sep="\n", what="") )[
    -c(1:2, 6), ,drop=FALSE],"data/rule.smote/dev.only.tomcat-jrip-month-c50.clique.txt",append=TRUE)
write(as.character(summary(c50.3)),"data/rule.smote/dev.only.tomcat-jrip-month-c50.chain.txt")
write(as.matrix(scan(text=.jcall(c50.3$classifier, "S", "toString") ,sep="\n", what="") )[
    -c(1:2, 6), ,drop=FALSE],"data/rule.smote/dev.only.tomcat-jrip-month-c50.chain.txt",append=TRUE)
write(as.character(summary(c50.4)),"data/rule.smote/dev.only.tomcat-jrip-month-c50.CD.txt")
write(as.matrix(scan(text=.jcall(c50.4$classifier, "S", "toString") ,sep="\n", what="") )[
    -c(1:2, 6), ,drop=FALSE],"data/rule.smote/dev.only.tomcat-jrip-month-c50.CD.txt",append=TRUE)
write(as.character(summary(c50.5)),"data/rule.smote/dev.only.tomcat-jrip-month-c50.IXPD.txt")
write(as.matrix(scan(text=.jcall(c50.5$classifier, "S", "toString") ,sep="\n", what="") )[
    -c(1:2, 6), ,drop=FALSE],"data/rule.smote/dev.only.tomcat-jrip-month-c50.IXPD.txt",append=TRUE)
