...
```{r read package csv dev.only.junit}
...
# library(data.table)
# pkg.merged<-fread("cache/dev.only.junit/package_merged.csv")
# pkg.merged[,.(commit_time=to.timestamp.fromint(pkg.merged$commit_time))]
# head(pkg.merged)

pkg.merged.df <- read.csv("cache/junit/package_merged.dev.csv",
                          head=TRUE,
                          sep=",")
...
set.seed(825)
confusionMatricesNB <- runCV(pkg.dataset.nzv, models, targets, "dev.only.junit-month-")
write.csv(confusionMatricesNB, "dev.only.junit-month-cm-ALL-nb.csv")
#```

#```{r train C5.0 and all targets}
models <- c("C5.0") # "C5.0" "logreg" has some issues, should be tested outside
set.seed(825)
confusionMatricesC50 <- runCV(pkg.dataset.nzv, models, targets, "dev.only.junit-month-")
write.csv(confusionMatricesC50, "dev.only.junit-month-cm-ALL-c50.csv")
#```
...
set.seed(825)
confusionMatricesRF <- runCV(pkg.dataset.nzv, models, targets, "dev.only.junit-month-")
write.csv(confusionMatricesRF, "dev.only.junit-month-cm-ALL-rf.csv")
#```

#```{r write all confusion matrices}
write.csv(rbind(confusionMatricesNB, confusionMatricesC50, confusionMatricesRF), "dev.only.junit-month-cm-ALL-ALL.csv")
```
...
confusionMatricesSVMRadial <- runCV.svm(pkg.dataset.nzv, grid, models, targets, "dev.only.junit-month-")
write.csv(confusionMatricesSVMRadial, "dev.only.junit-month-cm-ALL-svm-radial.csv")
```
...
confusionMatricesSVMlinear <- runCV.svm(pkg.dataset.nzv, grid, models, targets, "dev.only.junit-month-")
write.csv(confusionMatricesSVMlinear, "dev.only.junit-month-cm-ALL-svm-linear.csv")

```


[1] "Model: nb"
 [1] "star"           "numjavafile-1"  "nummail-1"      "numClasses-1"   "numPackages-1"  "numjavafile-2"  "nummail-2"      "numClasses-2"   "numjavafile-3"  "nummail-3"      "numClasses-3"  
[12] "numjavafile-4"  "nummail-4"      "numClasses-4"   "numPackages-4"  "numjavafile-5"  "nummail-5"      "numClasses-5"   "numPackages-5"  "numjavafile-6"  "nummail-6"      "numClasses-6"  
[23] "numPackages-6"  "numjavafile-7"  "nummail-7"      "numClasses-7"   "numjavafile-8"  "nummail-8"      "numClasses-8"   "numjavafile-9"  "nummail-9"      "numClasses-9"   "numjavafile-10"
[34] "nummail-10"     "numClasses-10"  "numjavafile-11" "nummail-11"     "numClasses-11"  "numjavafile-12" "nummail-12"     "numClasses-12" 
Aggregating results
Selecting tuning parameters
Fitting fL = 0, usekernel = FALSE, adjust = 1 on full training set
[1] "Model: nb"
 [1] "tiny"           "numjavafile-1"  "nummail-1"      "numClasses-1"   "numPackages-1"  "numjavafile-2"  "nummail-2"      "numClasses-2"   "numjavafile-3"  "nummail-3"      "numClasses-3"  
[12] "numjavafile-4"  "nummail-4"      "numClasses-4"   "numPackages-4"  "numjavafile-5"  "nummail-5"      "numClasses-5"   "numPackages-5"  "numjavafile-6"  "nummail-6"      "numClasses-6"  
[23] "numPackages-6"  "numjavafile-7"  "nummail-7"      "numClasses-7"   "numjavafile-8"  "nummail-8"      "numClasses-8"   "numjavafile-9"  "nummail-9"      "numClasses-9"   "numjavafile-10"
[34] "nummail-10"     "numClasses-10"  "numjavafile-11" "nummail-11"     "numClasses-11"  "numjavafile-12" "nummail-12"     "numClasses-12" 
Aggregating results
...
[1] "Model: nb"
 [1] "chain"          "numjavafile-1"  "nummail-1"      "numClasses-1"   "numPackages-1"  "numjavafile-2"  "nummail-2"      "numClasses-2"   "numjavafile-3"  "nummail-3"      "numClasses-3"  
[12] "numjavafile-4"  "nummail-4"      "numClasses-4"   "numPackages-4"  "numjavafile-5"  "nummail-5"      "numClasses-5"   "numPackages-5"  "numjavafile-6"  "nummail-6"      "numClasses-6"  
[23] "numPackages-6"  "numjavafile-7"  "nummail-7"      "numClasses-7"   "numjavafile-8"  "nummail-8"      "numClasses-8"   "numjavafile-9"  "nummail-9"      "numClasses-9"   "numjavafile-10"
[34] "nummail-10"     "numClasses-10"  "numjavafile-11" "nummail-11"     "numClasses-11"  "numjavafile-12" "nummail-12"     "numClasses-12" 
Aggregating results
...
Fitting fL = 0, usekernel = FALSE, adjust = 1 on full training set
[1] "Model: nb"
 [1] "CD"             "numjavafile-1"  "nummail-1"      "numClasses-1"   "numPackages-1"  "numjavafile-2"  "nummail-2"      "numClasses-2"   "numjavafile-3"  "nummail-3"      "numClasses-3"  
[12] "numjavafile-4"  "nummail-4"      "numClasses-4"   "numPackages-4"  "numjavafile-5"  "nummail-5"      "numClasses-5"   "numPackages-5"  "numjavafile-6"  "nummail-6"      "numClasses-6"  
[23] "numPackages-6"  "numjavafile-7"  "nummail-7"      "numClasses-7"   "numjavafile-8"  "nummail-8"      "numClasses-8"   "numjavafile-9"  "nummail-9"      "numClasses-9"   "numjavafile-10"
[34] "nummail-10"     "numClasses-10"  "numjavafile-11" "nummail-11"     "numClasses-11"  "numjavafile-12" "nummail-12"     "numClasses-12" 
Aggregating results
...
Fitting fL = 0, usekernel = TRUE, adjust = 1 on full training set
[1] "Model: nb"
 [1] "UD"             "numjavafile-1"  "nummail-1"      "numClasses-1"   "numPackages-1"  "numjavafile-2"  "nummail-2"      "numClasses-2"   "numjavafile-3"  "nummail-3"      "numClasses-3"  
[12] "numjavafile-4"  "nummail-4"      "numClasses-4"   "numPackages-4"  "numjavafile-5"  "nummail-5"      "numClasses-5"   "numPackages-5"  "numjavafile-6"  "nummail-6"      "numClasses-6"  
[23] "numPackages-6"  "numjavafile-7"  "nummail-7"      "numClasses-7"   "numjavafile-8"  "nummail-8"      "numClasses-8"   "numjavafile-9"  "nummail-9"      "numClasses-9"   "numjavafile-10"
[34] "nummail-10"     "numClasses-10"  "numjavafile-11" "nummail-11"     "numClasses-11"  "numjavafile-12" "nummail-12"     "numClasses-12" 
Aggregating results
...
Fitting fL = 0, usekernel = FALSE, adjust = 1 on full training set
[1] "Model: nb"
 [1] "IXPD"           "numjavafile-1"  "nummail-1"      "numClasses-1"   "numPackages-1"  "numjavafile-2"  "nummail-2"      "numClasses-2"   "numjavafile-3"  "nummail-3"      "numClasses-3"  
[12] "numjavafile-4"  "nummail-4"      "numClasses-4"   "numPackages-4"  "numjavafile-5"  "nummail-5"      "numClasses-5"   "numPackages-5"  "numjavafile-6"  "nummail-6"      "numClasses-6"  
[23] "numPackages-6"  "numjavafile-7"  "nummail-7"      "numClasses-7"   "numjavafile-8"  "nummail-8"      "numClasses-8"   "numjavafile-9"  "nummail-9"      "numClasses-9"   "numjavafile-10"
[34] "nummail-10"     "numClasses-10"  "numjavafile-11" "nummail-11"     "numClasses-11"  "numjavafile-12" "nummail-12"     "numClasses-12" 
Aggregating results
...
models <- c("nb") # "C5.0" "logreg" has some issues, should be tested outside
set.seed(825)
confusionMatricesNB <- runCV.smote(pkg.dataset.nzv, models, targets, "smot
e.dev.only.junit-month-")
write.csv(confusionMatricesNB, "smote.dev.only.junit-month-cm-ALL-nb.csv")
#```

#```{r train C5.0 and all targets}
models <- c("C5.0") # "C5.0" "logreg" has some issues, should be tested outside
set.seed(825)
confusionMatricesC50 <- runCV.smote(pkg.dataset.nzv, models, targets, "smote.dev.only.junit-month-")
write.csv(confusionMatricesC50, "smote.dev.only.junit-month-cm-ALL-c50.csv")
#```
...
models <- c("rf") # "C5.0" "logreg" has some issues, should be tested outside
set.seed(825)
confusionMatricesRF <- runCV.smote(pkg.dataset.nzv, models, targets, "smote.dev.only.junit-month-")
write.csv(confusionMatricesRF, "smote.dev.only.junit-month-cm-ALL-rf.csv")
#```

#```{r write all confusion matrices}
write.csv(rbind(confusionMatricesNB, confusionMatricesC50, confusionMatricesRF), "smote.dev.only.junit-month-cm-ALL-ALL.csv")
```
...
# models <- c("C5.0") # "C5.0" "logreg" has some issues, should be tested outside
# set.seed(825)
# trainC50 <- run50CV(pkg.dataset.nzv.binary, models, targets, "dev.only.junit-")

# library(rJava)
modelLookup("JRip")
models <- c("JRip")
set.seed(825)
trainjrip <- run50CV(pkg.dataset.nzv.binary, models, targets, "dev.only.junit-")
# write.csv(pkg.dataset.nzv.binary, "dev.only.junit-cm-lagged-week.csv")
    ...
    write(as.character(summary(c50.1)), "data/rule/dev.only.junit-jrip-month-c50.star.txt")
    write(as.matrix(scan(text = .jcall(c50.1$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule/dev.only.junit-jrip-month-c50.star.txt", append = TRUE)
    write(as.character(summary(c50.2)), "data/rule/dev.only.junit-jrip-month-c50.tiny.txt")
    write(as.matrix(scan(text = .jcall(c50.2$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule/dev.only.junit-jrip-month-c50.tiny.txt", append = TRUE)
    write(as.character(summary(c50.3)), "data/rule/dev.only.junit-jrip-month-c50.chain.txt")
    write(as.matrix(scan(text = .jcall(c50.3$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule/dev.only.junit-jrip-month-c50.chain.txt", append = TRUE)
    write(as.character(summary(c50.4)), "data/rule/dev.only.junit-jrip-month-c50.cd.txt")
    write(as.matrix(scan(text = .jcall(c50.4$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule/dev.only.junit-jrip-month-c50.cd.txt", append = TRUE)
    write(as.character(summary(c50.5)), "data/rule/dev.only.junit-jrip-month-c50.ud.txt")
    write(as.matrix(scan(text = .jcall(c50.5$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule/dev.only.junit-jrip-month-c50.ud.txt", append = TRUE)
    write(as.character(summary(c50.6)), "data/rule/dev.only.junit-jrip-month-c50.ixpd.txt")
    write(as.matrix(scan(text = .jcall(c50.6$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule/dev.only.junit-jrip-month-c50.ixpd.txt", append = TRUE)
...
# write.csv(pkg.dataset.nzv.binary, "dev.only.junit-cm-lagged-week.csv")
    ...
    write(as.character(summary(c50.1)), "data/rule.smote/dev.only.junit-jrip-month-c50.star.txt")
    write(as.matrix(scan(text = .jcall(c50.1$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule.smote/dev.only.junit-jrip-month-c50.star.txt", append = TRUE)
    write(as.character(summary(c50.2)), "data/rule.smote/dev.only.junit-jrip-month-c50.tiny.txt")
    write(as.matrix(scan(text = .jcall(c50.2$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule.smote/dev.only.junit-jrip-month-c50.tiny.txt", append = TRUE)
    write(as.character(summary(c50.3)), "data/rule.smote/dev.only.junit-jrip-month-c50.chain.txt")
    write(as.matrix(scan(text = .jcall(c50.3$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule.smote/dev.only.junit-jrip-month-c50.chain.txt", append = TRUE)
    write(as.character(summary(c50.4)), "data/rule.smote/dev.only.junit-jrip-month-c50.cd.txt")
    write(as.matrix(scan(text = .jcall(c50.4$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule.smote/dev.only.junit-jrip-month-c50.cd.txt", append = TRUE)
    write(as.character(summary(c50.5)), "data/rule.smote/dev.only.junit-jrip-month-c50.ud.txt")
    write(as.matrix(scan(text = .jcall(c50.5$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule.smote/dev.only.junit-jrip-month-c50.ud.txt", append = TRUE)
    write(as.character(summary(c50.6)), "data/rule.smote/dev.only.junit-jrip-month-c50.ixpd.txt")
    write(as.matrix(scan(text = .jcall(c50.6$classifier, "S", "toString"), sep = "\n", what = ""))[
    -c(1:2, 6),, drop = FALSE], "data/rule.smote/dev.only.junit-jrip-month-c50.ixpd.txt", append = TRUE)
